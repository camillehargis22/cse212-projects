...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Enqueue funciton in PersonQueue was inserting at the front instead of adding at the back
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Added an else if for when the turns are 1 to just return and not add back in queue. Added an else for when turns are less than 1 to not change the turns, but to add back in queue.
